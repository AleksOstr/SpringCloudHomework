...
Что было сделано:
1. Реализован аспект TimerAspect, который измеряет время выполнения метода с аннотацией @Timer.
2. Собран timer-starter.
3. В микросервисы подключен timer-starter, аннотация @Timer расставлена над методами в контроллерах каждого миркосервиса.
